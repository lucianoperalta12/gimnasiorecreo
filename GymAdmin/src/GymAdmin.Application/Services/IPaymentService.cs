...
{
    Task<PagedResult<PaymentListDto>> GetAllAsync(int requesterId, int? gymId = null, int? membresiaId = null, DateOnly? fechaDesde = null, DateOnly? fechaHasta = null, int? page = null, int? pageSize = null);
