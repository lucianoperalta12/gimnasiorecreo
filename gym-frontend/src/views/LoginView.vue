<template>
  <div class="min-h-screen flex items-center justify-center p-4 bg-dark-950 relative overflow-hidden">
    ...
    <div class="relative w-full max-w-md animate-fade-in">
      ...
      <!-- Login Card -->
      <div class="card p-8 sm:p-10 border border-dark-800  bg-dark-900/60 backdrop-blur-xl rounded-[2.5rem] relative overflow-hidden group">
        <!-- Subtle inner glow -->
        ...
        <form @submit.prevent="handleLogin" class="space-y-6 relative z-10">
          ...
          <button
            type="submit"
            :disabled="loading"
            class="w-full py-4 px-6 bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-500 hover:to-primary-400 text-white font-black uppercase tracking-widest rounded-2xl  active:scale-[0.98] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed group"
          >
